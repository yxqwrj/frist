...
if __name__ == '__main__':
    ...
    for i in range(Episode):
        ...
        append_list_to_csv(every_edge_load_balance, 'C:/Users/12165/Desktop/game/0.2/every_edge_load_balance.csv', 1)  # 每次迭代记录10个边缘服务器的负载均衡，每行是一代，列表
        value_to_csv(avg_edge_load_balance, 'C:/Users/12165/Desktop/game/0.2/avg_edge_load_balance.csv', 1)  # 每次迭代记录10个边缘服务器的负载均衡均值，每行是一代，数值
        value_to_csv(Lb_every_edge_load_balance, 'C:/Users/12165/Desktop/game/0.2/Lb_every_edge_load_balance.csv', 1)  # 每次迭代记录各个边缘服务器的负载均衡均值，每行是一代，数值
        append_list_to_csv(record_a_mxa, 'C:/Users/12165/Desktop/game/0.2/record_a_mxa.csv', 1)  # 每次迭代记录该代策略，每行是一代，列表
        value_to_csv(SC_total_value, 'C:/Users/12165/Desktop/game/0.2/SC_total_value.csv', 1)  # 每次迭代记录总体成本，每行是一代，数值
        value_to_csv(SC_total_delay, 'C:/Users/12165/Desktop/game/0.2/SC_total_delay.csv', 1)  # 每次迭代记录总体时延，每行是一代，数值
        value_to_csv(SC_total_energy, 'C:/Users/12165/Desktop/game/0.2/SC_total_energy.csv', 1)  # 每次迭代记录总体能量，每行是一代，数值
