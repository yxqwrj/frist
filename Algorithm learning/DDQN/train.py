...
def main():
    ...
    for alpha in alpha_values:
        agent = DDQN(alpha=alpha, state_dim=5, action_dim=2,
        ...
        for episode in range(args.max_episodes):
            ...
            save_rewards_to_csv(episode + 1, total_reward, 'C:/Users/12165/Desktop/DDQN_R.csv')
    ...
    for i, alpha in enumerate(alpha_values):
        plt.plot(reward_plots[i], label=f'alpha={alpha}')
        plt.xlabel("episode")
        plt.ylabel("reward")
        plt.legend()
    #plt.show()
